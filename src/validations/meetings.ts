 ...
 *
 * Same shape as scheduling/confirm but chat_room_id is REQUIRED.
 */
export const meetingFromChatSchema = z.object({
  ...
  meeting_url: z
    ...
    .max(2048)
    .optional(),
  chat_room_id: z.string().uuid("有効なchat_room_idが必要です"),
});

export type MeetingFromChatInput = z.infer<typeof meetingFromChatSchema>;
