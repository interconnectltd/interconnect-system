                ...
                <div class="profile-detail-body">
                    ...
                    <div class="profile-detail-actions">
                        <button class="profile-detail-btn profile-detail-btn-primary" 
                                onclick="window.profileDetailModal.sendConnect('${profile.id}')">
                            <i class="fas fa-link"></i>
                            コネクト申請
                        </button>
                        <button class="profile-detail-btn profile-detail-btn-secondary"
                                onclick="window.profileDetailModal.sendMessage('${profile.id}')">
                            <i class="fas fa-envelope"></i>
                            メッセージ送信
                        </button>
                        <button class="profile-detail-btn profile-detail-btn-secondary"
                                onclick="window.profileDetailModal.bookmark('${profile.id}')">
